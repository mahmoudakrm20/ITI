...
export default function Navbar({cartItem}) {
  return (
    ...
    <Link to ="/"><a className="btn btn-ghost text-xl">ITI Burger</a></Link>
      <Link to ="/menu"><button className='btn'>Menu</button></Link>
      <Link to ="/about"><button className='btn ml-2'>About</button></Link>
      ...
      <div className="dropdown dropdown-end">
        ...
        <div
          ...
          <div className="card-body">
            <span className="text-lg font-bold">{cartItem.length}</span>
